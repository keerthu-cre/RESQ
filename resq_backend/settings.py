...
SECRET_KEY = os.environ.get(
    'SECRET_KEY',
    'django-insecure-resq-emergency-management-system-secret-key-2025-v1'
)
...
ASGI_APPLICATION = 'resq_backend.asgi.application'
...
# CORS Settings for Mobile / Frontend Integration
CORS_ALLOW_ALL_ORIGINS = True  # Permissive for Person 1 and Person 2 dev testing
...
if USE_REDIS:
    ...
    # Defaulting to InMemoryChannelLayer ensures local dev runs out of the box without Redis daemon
    CHANNEL_LAYERS = {
        'default': {
